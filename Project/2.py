...
rrp.load_reranker_model('/home/sai/.local/share/bllipparser/WSJ-PTB3/reranker/features.gz',
                        '/home/sai/.local/share/bllipparser/WSJ-PTB3/reranker/weights.gz')
...
with open('lm_data.txt', "w", encoding="utf-8") as fn:
    with open('si_data.txt', "w", encoding="utf-8") as fp:
        with open('tr_data.txt', "w", encoding="utf-8") as ft:
            in_list = []
                           ...
                           # break 
                            ...
                            for te in parse_sent[0].ptb_parse.sd_tokens():
                                if te.deprel == 'nsubj' and te.form == npnew.leaves()[-1]:
                                    sub_ind = 1
                                if te.deprel == 'root' and te.form == npnew.leaves()[-1] and (
                                        te.cpos == 'NN' or te.cpos == 'NNS'):
                                    sub_ind = 1
